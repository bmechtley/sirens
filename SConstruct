...
# Headers.
install_headers = {
	'/segmentation': ['source/segmentation/' + s for s in ['SegmentationParameters.h', 'Segmenter.h']],
	'/retrieval': ['source/retrieval/' + s for s in ['FeatureComparator.h', 'SoundComparator.h', 'SimpleFeatureComparator.h', 'SimpleSoundComparator.h']],
	'/features': ['source/features/' + s for s in ['SpectralCentroid.h', 'SpectralSparsity.h', 'TemporalSparsity.h', 'TransientIndex.h', 'Harmonicity.h', 'Loudness.h']],
	'/stk': ['source/stk/' + s for s in ['Stk.h', 'FileRead.h']],
	'': ['CircularArray.h', 'FeatureSet.h', 'Feature.h', 'Sound.h', 'Thread.h', 'Sirens.h']
}
